...
class Student {
        public int studentid;//instance variables
        String name;
        String email;
        long phone;
        ...
        public String toString(){
            ...
            return "studentid : "+studentid+" name : "+name+" mail "+email+"mobile"+phone;
        }
...
class Studentmain{
    public static void main(String[] args) {
        ...
        Student stu1=new Student();//did theses changes on day 18 (8th feb 2024) while discusiing about
        stu1.email="stu1.mail";//predefined classes
        stu1.studentid=1111;//and how the tostring() method will be called by default while doing sout()
        stu1.phone=11111111;
        stu1.name="stu1";
        ...
        System.out.println(stu1);//till here the new changes
